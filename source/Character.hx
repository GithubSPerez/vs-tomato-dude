	...
	public function new(x:Float, y:Float, ?character:String = "bf", ?isPlayer:Bool = false)
	{
		...
		switch (curCharacter)
		{
			...
			case 'dad':
				...
				tex = Paths.getSparrowAtlas('TOMATO');
				frames = tex;
				animation.addByPrefix('idle', 'Tomato idle dance', 24);
				animation.addByPrefix('singUP', 'Tomato Sing Note UP', 24);
				animation.addByPrefix('singRIGHT', 'Tomato Sing Note RIGHT', 24);
				animation.addByPrefix('singDOWN', 'Tomato Sing Note DOWN', 24);
				animation.addByPrefix('singLEFT', 'Tomato Sing Note LEFT', 24);

				addOffset('idle');
				addOffset("singUP", -6, 50);
				addOffset("singRIGHT", 0, 27);
				addOffset("singLEFT", 260, 25);
